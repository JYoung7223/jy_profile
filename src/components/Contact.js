...
function Contact(){    
    return (
        ...
        <div className="row border-top no-gutters">
            ...
            <p className="col-3 text-center text-company-primary">Email:
                <a href="mailto:jyoung7223@yahoo.com?subject=USS-Connect"><i className="fa fa-envelope-o">jyoung7223@yahoo.com</i></a>
            </p>
            <p className="col-3 text-center text-company-primary">Telephone:
                <a href="tel:801-541-9922"><i className="fa fa-phone"> 801-541-9922</i></a>
            </p>
            <p className="col-3 text-center text-company-primary">Text:
                <a href="sms:801-541-9922&body=USS-Connect"><i className="fa fa-comment"> 801-541-9922 </i></a>
            </p>
            <p className="col-3 text-center text-company-primary">
                <a href="./assets/documents/justin-young-resume.pdf" download><i className="fa fa-download" aria-hidden="true"> Download Resume Copy</i></a>
            </p>
        </div>
